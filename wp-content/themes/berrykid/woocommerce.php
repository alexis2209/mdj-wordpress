...
$berrykid_page_layouts = apply_filters( 'berrykid_fnc_get_woocommerce_sidebar_configs', null );

get_header( apply_filters( 'berrykid_fnc_get_header_layout', null ) );

if( is_singular('product') ) {
 $bgimage = berrykid_fnc_theme_options( 'woocommerce-single-breadcrumb' ); 
 $style = array();
 if( $bgimage  ){ 
...
<section id="main-container" class="<?php echo apply_filters('berrykid_template_woocommerce_main_container_class','container');?>">
		...
		<div id="main-content" class="main-content col-xs-12 <?php echo esc_attr($berrykid_page_layouts['main']['class']); ?>">
			<div id="primary" class="content-area">
				<div id="content" class="site-content" role="main">
					 ...
					 <?php  berrykid_fnc_woocommerce_content(); ?>
