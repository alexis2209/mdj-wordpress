...
$berrykid_page_layouts = apply_filters( 'berrykid_fnc_sidebars_others_configs', null );

if( isset($berrykid_page_layouts['sidebars']) ): $sidebars = $berrykid_page_layouts['sidebars']; 
?> 
