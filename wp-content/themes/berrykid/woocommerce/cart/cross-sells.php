...
if ( $products->have_posts() ) : ?>
	...
	<div class="cross-sells">
		...
		<h2><?php esc_html_e( 'You may be interested in&hellip;', 'berrykid' ) ?></h2>
		...
		<div class="widget products-collection owl-carousel-play woocommerce" id="postcarousel-<?php echo esc_attr($_id); ?>" data-ride="carousel" >
			<div class="woocommerce">
				<div class="widget-content <?php echo isset($style) ? esc_attr( $style ): ''; ?>">
				    ...
				    <div class="owl-carousel " data-slide="<?php echo esc_attr($columns_count); ?>"  data-singleItem="true" data-navigation="false" data-pagination="false" data-desktop="[1199,2]" data-desktopsmall="[980,1]" data-tablet="[768,2]">
