...
<div id="quickview-carousel" class="carousel slide" data-ride="carousel">
	...
	<!-- Controls -->
	<a class="left carousel-control carousel-xs" href="#quickview-carousel" data-slide="prev">
        <span class="fa fa-chevron-left"></span>
    </a>
    <a class="right carousel-control carousel-xs" href="#quickview-carousel" data-slide="next">
